...
export default function Home() {
  ...
  const cards = [
    ...
    },
    {
      ...
      image: { src: "/images/machine.png", width: 250, height: 200, alt: "Elevator Machines" },
    ...
    <div className="gradient-bg min-h-screen">
      ...
      <section className="relative min-h-[900px] h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] xl:h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8">
          ...
          <Button asChild variant="outline"  className="lg bg-buttonf hover:text-primary-foreground px-4 py-2 rounded">
